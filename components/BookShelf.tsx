...
import { Play, Search, User, Loader2, BookMarked, LayoutGrid, Trash2 } from 'lucide-react';
...
export default function BookShelf() {
  ...
  const fetchBooks = async () => {
    setLoading(true);
    // Mudamos para updated_at para a ordenação inteligente funcionar
    ...
    <div className="min-h-screen bg-[#F8F9F7] text-[#1A1A1A] font-sans pb-40">
      ...
      <header className="sticky top-0 z-50 bg-[#F8F9F7]/80 backdrop-blur-xl border-b border-stone-200/50 px-6 py-5 flex justify-between items-center">
        ...
        <div className="flex items-center gap-5 text-stone-500">
          ...
          <div className="w-8 h-8 rounded-full bg-stone-200 flex items-center justify-center shadow-inner">
